...
const MundoNews = () => {
  ...
  const col1 = $('<div class="col-md-3 pd-l-0 newsGrande"></div>');
  const col2 = $('<div class="col-md-6 newsCentro"></div>');
  const col3 = $('<div class="col-md-3 pd-r-0 newsGrande"></div>');
  const sub1 = $('<div class="col-md-6 pd-l-0"></div>');
  const sub2 = $('<div class="col-md-6 pd-r-0"></div>');
  const sub3 = $('<div class="col-xs-12 pd-l-0"></div>');
  const sub4 = $('<div class="col-xs-12 pd-l-0"></div>');
    
  const container2 = $('<div class="container pd-0 contenedor"></div>');
  const col4 = $('<div class="col-md-3 pd-l-0 newsVertical imagen"></div>');
  const col5 = $('<div class="col-md-3 newsVertical imagen"></div>');
  const col6 = $('<div class="col-md-3 newsVertical imagen"></div>');
  const col7 = $('<div class="col-md-3 pd-r-0 newsVertical imagen"></div>');

  console.log(state.mundo);
  sub1.append(News(state.mundo[1]));
  sub2.append(News(state.mundo[2]));
  sub3.append(newsHorizontal(state.mundo[4]));
  sub4.append(newsHorizontal(state.mundo[5]));
