...
const EduNews = () => {
  ...
  const col2 = $('<div class="col-md-12"></div>');
  const sub1 = $('<div class="col-md-3 imagen"></div>');
  const sub2 = $('<div class="col-md-3 imagen"></div>');
  const sub3 = $('<div class="col-md-3 imagen"></div>');
  const sub4 = $('<div class="col-md-3 imagen"></div>');
